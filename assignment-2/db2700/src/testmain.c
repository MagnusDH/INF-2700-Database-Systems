...
int main(int argc, char* argv[]) {
  ...
  */
  ...
  char my_tbl[] = "Me";
  //Create new test schema and add 1000 records to it
  test_tbl_write(my_tbl); 

  printf("TESTING LINEAR SEARCH with value: 0\n");
  test_tbl_read(my_tbl, 0, 0);
  printf("DONE\n");

  printf("TESTING BINARY SEARCH with value: 0\n");
  test_tbl_read(my_tbl, 1, 0);
  printf("DONE\n\n");

  printf("TESTING LINEAR SEARCH with value: 59\n");
  test_tbl_read(my_tbl, 0, 59);
  printf("DONE\n");

  printf("TESTING BINARY SEARCH with value: 59\n");
  test_tbl_read(my_tbl, 1, 59);
  printf("DONE\n\n");

  printf("TESTING LINEAR SEARCH with value: 60\n");
  test_tbl_read(my_tbl, 0, 60);
  printf("DONE\n");

  printf("TESTING BINARY SEARCH with value: 60\n");
  test_tbl_read(my_tbl, 1, 60);
  printf("DONE\n\n");

  printf("TESTING LINEAR SEARCH with value: 999\n");
  test_tbl_read(my_tbl, 0, 999);
  printf("DONE\n");

  printf("TESTING BINARY SEARCH with value: 999\n");
  test_tbl_read(my_tbl, 1, 999);
  printf("DONE\n\n");

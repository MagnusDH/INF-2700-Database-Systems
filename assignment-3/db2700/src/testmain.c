...
int main(int argc, char* argv[]) {
  ...
  */
  ...
  //EVERYTHING FROM HERE IS MY CODE
  char test_tbl1[] = "Table1";
  char test_tbl2[] = "Table2";
  
  create_test_tbl(test_tbl1, 100, "id", "Int", 0);
  create_test_tbl(test_tbl2, 100, "number", "Int", 1);

  open_db();

  tbl_p t1 = get_table(test_tbl1);
  tbl_p t2 = get_table(test_tbl2);

  MY_test_tbl_natural_join(t1, t2);
